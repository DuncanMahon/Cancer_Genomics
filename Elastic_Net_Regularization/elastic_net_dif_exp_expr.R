...
### differential expression results 3 (final gene list)
### expression
...
mse_vec <- c(mse0,mse1,mse2,mse3,mse4,mse5,mse6,mse7,mse8,mse9,mse10,
             mse11,mse12,mse13,mse14,mse15,mse16,mse17,mse18,mse19,mse20)

which(mse_vec==min(mse_vec))
#17, mse 16
#mse = 1.203627
#alpha = 0.8

#create model with alpha = 0.8
cv1 <- cv.glmnet(m_training, BFB_train, family = "binomial", nfold = 10, type.measure = "deviance", paralle = TRUE, alpha = 0.8)
md1 <- glmnet(m_training, BFB_train, family = "binomial", lambda = cv1$lambda.1se, alpha = 0.8)
coef(md1)
#interesting
#MUC6, NPC1L1, SLC9A4 all predictive